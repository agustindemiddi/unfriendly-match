...
const AsideNavigationTournamentItem = ({ navItem }) => {
  ...
  const { updatedActiveTournamentsMatches } = getUserAuthCtx();
  ...
  const tournamentMatches = updatedActiveTournamentsMatches?.filter(match => match.tournament === tournamentId)
